    ...
    private DecryptVerifyResult decryptVerify(
        ...
        while (it.hasNext()) {
            ...
            if (obj instanceof PGPPublicKeyEncryptedData) {
                ...
                if ( ! PgpConstants.isSecureKey(secretEncryptionKey)) {
        ...
        if (!PgpConstants.isSecureSymmetricAlgorithm(symmetricEncryptionAlgo)) {
        ...
        if (dataChunk instanceof PGPOnePassSignatureList) {
            ...
            if (signingKey != null && ! PgpConstants.isSecureKey(signingKey)) {
                log.add(LogType.MSG_DC_INSECURE_KEY, indent + 1);
        ...
        if (dataChunk instanceof PGPLiteralData) {
            ...
            if (signature != null) {
                ...
                if (!PgpConstants.isSecureHashAlgorithm(signature.getHashAlgorithm())) {
